...
#define MEMORY_MAX (vaddr_t)0xFFFFFFFFFFFFFFFFul
...
// ? (32) or 0xFFFFFFF800000000 (64)
#define MEMORY_DMA_VIRT_BASE (vaddr_t)0xFFFFFFF800000000ull

// ? (32) or 0xFFFFFFFC00000000 (64)
#define MEMORY_MMIO_VIRT_BASE (vaddr_t)0xFFFFFFFC00000000ull

#define MEMORY_PHYS_COPY_SRC  (vaddr_t)0xFFFFFFFD00000000ull // scratch window 1
#define MEMORY_PHYS_COPY_DST  (vaddr_t)0xFFFFFFFD00001000ull // scratch window 2

// ? (32) or 0xFFFFFFFDF0000000 (64)
#define MEMORY_CPU_STACKS_VIRT_BASE (vaddr_t)0xFFFFFFFDF0000000ull

// ? (32) or 0xFFFFFFFE00000000 (64)
#define MEMORY_STACKS_VIRT_BASE (vaddr_t)0xFFFFFFFE00000000ull

// ? (32) or 0xFFFFFFFE80000000 (64)
#define MEMORY_HEAP_VIRT_BASE (vaddr_t)0xFFFFFFFE80000000ull
