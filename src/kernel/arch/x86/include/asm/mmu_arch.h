...
/// @retval KERRNO_BAD_VALUE: table is not valid
...
/// @return 0 on successes or an errno number
/// @retval KERRNO_BAD_VALUE: dst or src is not valid
...
/// @retval KERRNO_NOT_ALLOWED: phys or virt is not valid e.g. They are too large or not page aligned
/// @retval KERRNO_BAD_VALUE: flags or table are not valid
/// @retval KERRNO_BAD_ADDRESS: virt exceeds the virtual space of the CPU
...
/// @retval KERRNO_NOT_ALLOWED: virt is not valid e.g. It is too large or not page aligned
/// @retval KERRNO_BAD_VALUE: table is not valid
/// @retval KERRNO_BAD_ADDRESS: virt exceeds the virtual space of the CPU
/// @retval KERRNO_ENTRY_NOT_FOUND: no entry exists at that virtual address
...
/// @return 0 on successes or an errno number
/// @retval KERRNO_NOT_ALLOWED: virt is not valid e.g. It is too large or not page aligned
/// @retval KERRNO_BAD_VALUE: table are not valid
/// @retval KERRNO_BAD_ADDRESS: virt exceeds the virtual space of the CPU
/// @retval KERRNO_ENTRY_NOT_FOUND: entry does not exist in the given table
...
/// @retval KERRNO_NOT_ALLOWED: phys is not valid e.g. It is too large or not page aligned
/// @retval KERRNO_BAD_VALUE: table is not valid
/// @retval KERRNO_ENTRY_NOT_FOUND: no entry exists at that physical address
